...
?>
    <div class="product-wrapper">
        <div class="img-slide">
            <div class="slideshow-container">
                <div class="mySlides fadeToNext">
                    <img src="img/memorial1.jpg" style="width:100%" >
                </div>
                <div class="mySlides fadeToNext">
                    <img src="img/memorial2.jpg" style="width:100%">
                </div>
                <div class="mySlides fadeToNext">
                    <img src="img/memorial3.jpg" style="width:100%">
                </div>
        ...
        <div class="package-summary">
            ...
            <p class="summary-desc">Let us create a lasting tribute for your pet. Individual cremation, 1pc ceramic urn, 4R photo frame, and cremation certificate. </p>
            <div class="price-div">
            ...
            <form class="cart-variations" method="post" action="post-addCart.php">
                <input type="hidden" id="product-name" name="product-name" value="Memorial Package">
                <input type="hidden" id="price" name="price" value="">
                <input type="hidden" id="individual-price" name="singlePrice" value="">
                <input type="hidden" id="product-img-link" name="product-img-link" value="img/memorial1.jpg">
    ...
    <div class="description">
        ...
        <div class="desc-text">
            <p class="text-1">
                Memorial packages include free pickup any in Peninsular Malaysia, cremation, scattering of ashes and burial plot.
            </p>
            <p class="text-2">
            Owner can witness to crematorium(based appointment) and get ash on same day or with free Video record forward via Whatsapp for owner that unable to attend
            </p>
            <p class="text-3">
